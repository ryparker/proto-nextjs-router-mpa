...
/**
 * This React Hook offers you an interface to toggle and read the dark theme mode
 * between three values. It uses internally useLocalStorage() to persist the value
 * and listens the OS color scheme preferences.
 *
 * Returned value

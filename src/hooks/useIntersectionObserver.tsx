 ...
 * IntersectionObserver API natively present in the browser. It can be very useful
 * to lazy-loading of images, implementing "infinite scrolling" or starting animations
 * for example.
 *
